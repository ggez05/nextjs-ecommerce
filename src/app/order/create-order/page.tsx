  ...
  return (
    <div className="w-full h-full bg-gray-50 px-2">
      ...
      {loading || loader ? (
        ...
        <div className="w-full text-black h-full flex-col md:flex-row flex items-start justify-center">
            ...
            <div className="mr-16">
              ...
              <div className="w-full  py-2 my-2 flex justify-end ">
                <h1 className="py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col ">
                  ...
                  Total Order Price{" "}
                  <span className="text-xl font-extrabold">
                    Rs {totalPrice + (totalPrice * 18) / 100}
                  </span>{" "}
                </h1>
              </div>
            </div>
          ...
          <form
            ...
            className="md:w-1/3 px-2 w-full max-w-lg text-white  py-2 flex-col "
          >
