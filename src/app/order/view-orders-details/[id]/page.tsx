          ...
          <div className="w-full flex px-2 flex-wrap items-center  justify-center">
            ...
            {orderData?.orderItems.map((item, index) => {
              return (
                <div
                  key={index}
                  className="md:w-96 m-2 w-52 h-52 bg-white mt-10 flex md:flex-row  flex-col items-center justify-start"
                >
                  ...
                  <div className="flex  py-1 flex-col items-center w-1/2 justify-center align-middle">
